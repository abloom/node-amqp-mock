...
function restore() {
    ...
    qp.unsubscribe = o.qp.unsubscribe;
}
...
module.exports = function(connectionOptions) { // TODO: filter interceptions by connection options
    ...
    qp.subscribe = function() {
        this.emit('basicConsumeOk', {consumerTag: 1});
        this.state = 'open';
    ...
    qp.unsubscribe = function() {
      var result = o.qp.unsubscribe.apply(this, arguments);
      result.emitSuccess();
      return result;
    }
